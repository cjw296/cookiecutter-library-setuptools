...
http://{{ cookiecutter.project_slug }}.readthedocs.org/en/latest/

If you wish to contribute to this project, then you should fork the
repository found here:

https://github.com/{{ cookiecutter.github_path }}/
...
and push to https://github.com/{{ cookiecutter.github_path }}
